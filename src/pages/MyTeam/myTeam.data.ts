...
export const applicants: Applicant[] = [
  {
    ...
    school: "컴퓨터과학부 3학년",
    introduction:
      "공공데이터를 활용한 서비스 개발에 관심이 있으며, Spring과 PostgreSQL로 백엔드 API를 구현해왔습니다.",
    message: "Spring · PostgreSQL로 공공데이터 API 2개 만들어봤어요.",
    reason: "이 팀에 지원한 이유를 알려주세요",
    answer:
  ...
  },
  {
    ...
    school: "통계학과 4학년",
    introduction:
      "교통 데이터 분석 프로젝트를 통해 복잡한 데이터를 이해하기 쉬운 인사이트로 정리하는 경험을 쌓았습니다.",
  ...
  },
  {
    ...
    school: "산업디자인학과 3학년",
    introduction:
      "사용자에게 필요한 정보를 직관적으로 전달하는 화면을 설계하고, 발표 자료까지 완성도 있게 만드는 것을 좋아합니다.",
